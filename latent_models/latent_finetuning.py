...
import dataset_utils.dataset as text_dataset
...
class Trainer(object):
    def __init__(
        ...
        *,
        ...
        self.dataloader = text_dataset.get_dataloader(args, self.dataset['train'], config, self.tokenizer, args.max_seq_len)
        self.val_dataloader = text_dataset.get_dataloader(args, self.dataset['valid'], config, self.tokenizer, args.max_seq_len)
        ...
        with tqdm(initial = self.step, total = self.train_num_steps, disable = not accelerator.is_main_process) as pbar:
            ...
            while self.step < self.train_num_steps:
                ...
                with accelerator.autocast():
                    ...
                    loss = self.lm(labels=data['cdr3'], encoder_outputs=encoder_outputs).loss     
                ...
                if self.step % 50 == 0:
                    ...
                    with torch.no_grad():
                        ...
                        if self.args.lm_mode == 'freeze':
                            total_lm_val_loss += self.lm(input_ids = data['input_ids'], attention_mask = data['attention_mask'], labels=data['cdr3']).loss.item()
