...
def get_diffusion_latent_dims(args):
    if args.latent_model_path is None:
        config = AutoConfig.from_pretrained(args.enc_dec_model) #'PLM/prot_t5_xl_uniref50'
...
def main(args):
    ...
    trainer.general_sample(None,num_samples = args.num_samples,sampling_timesteps=250)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default='save_diff_all_her2')
